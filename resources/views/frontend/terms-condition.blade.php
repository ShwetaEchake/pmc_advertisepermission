<x-admin.layout>
    <x-slot name="title" >Terms Conditions / अटी व शर्ती</x-slot>
    <x-slot name="breadcrumb">Terms Conditions / अटी व शर्ती</x-slot>
    ...
    <div class="container my-5">
        ...
        <div class="row" id="addContainer">
            <div class="col-sm-12">
                <div class="card">
                    <h2 class="fs-lg fw-medium me-auto" style="margin: 15px">Terms Conditions / अटी व शर्ती</h2>
                    <hr>
                    <ul>
                        ...
                        <li style="text-align:justify; margin: 25px">
                            <strong>२) सदर फलकाबाबत कोणतीही तक्रार पनवेल महानगरपालिके कडे आल्यास व त्याप्रमाणे पनवेल महानगरपालिकेने आपणांस सदरचा फलक काढून घेणेबाबत कळविल्यास, आपण त्वरीत सदरचा फलक स्वखर्चाने काढून घ्यावयाचा आहे.</strong>
                        </li>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-4">
                            <a href="{{ route('application-form') }}"><button class="btn btn-primary">Accept Terms & Conditions / अटी व शर्ती लागू</button></a>
                        </div>
                    </div>
                </div>
            </div>
