            ...
            <div class="col-12">
                <div class="certificate-border">
                    <div class="certificate-inner-border">
                        ...
                        <table style="width: 95%; margin: auto; text-align:left; margin-top: -25px">
                            <thead>
                                <tr>
                                    <th style="width: 20%;">
                                        <div>
                                            <img style="width: 110px; height: 110px" src="{{ asset('frontend/img/pmc.png') }}" alt="">
                                        </div>
                                    </th>
                                    <th style="min-width: 60%; text-align: center;">
                                        <div>
                                            <h2 style="font-weight: 700"><strong>पनवेल महानगरपालिका, पनवेल</strong></h2>
                                        </div>
                                    </th>
                        ...
                        <table class="marathi-table">
                            <thead>
                                ...
                                <tr>
                                    <th style="width: 70%;">
                                        <strong>२) सदर फलकाबाबत कोणतीही तक्रार प.म.पा. कडे आल्यास व त्याप्रमाणे पनवेल महानगरपालिकेने आपणांस सदरचा फलक काढून घेणेबाबत कळविल्यास, आपण त्वरीत सदरचा फलक स्वखर्चाने काढून घ्यावयाचा आहे.</strong>
                                    </th>
                                </tr>
                                <tr>
                                    <th style="width: 70%;">
                                ...
                                <tr>
                                    <th style="width: 100%;">
                                        <strong>७) सदर फलकामुळे रहादीस. रस्ता रुंदीकरणास अडथळा होत असल्यास गहापालिकेकडून आपणांस कळविण्यात आल्यास सदरचा जाहिरात फलक साखर्थाने काढून घेण्याची जबाबदारी आपणांवर राहील. तसेच आपणास देण्यात येणाऱ्या मुदतीमध्ये आपण आहिरात फलक काढून घेतले नाही, तर सदरची कार्यवाही महानगरपालिकेकडून करण्यात येईल व त्यासाठी होणारा सर्व खर्च आपणाकडून वसूल करण्यात येईल.</strong>
                                    </th>
                                </tr>
                                <tr>
                                    <th style="width: 100%;">
                                ...
                                <tr>
                                    <th style="width: 100%;">
                                        <strong>१२) धर्म,जात,भाषा,प्रांत अशा कोणाच्याही भावना दुखावल्या जातील असे कोणतेही जाहिरात लावल्यास योग्य त्या कलमानुसार कायदेशीर कारवाई करण्यात येईल.</strong>
                                    </th>
                                </tr>
                            </thead>
                        </table>
                        ...
                        <div style="width: 98%; margin: auto; margin-top: 40px; text-align: center; margin-bottom: 20px;">
                            <strong>वरील अटी व शर्तीना अधीन राहून दि. दि. {{ ucwords($application->from_date)}} पासून दि.  दि. {{ ucwords($application->to_date)}} पर्यंत आपणास जाहिरात फलकाची परवानगी देण्यास येते.</strong>
                        </div>
                    </div>
                </div>
            </div>
