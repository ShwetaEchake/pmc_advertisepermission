    ...
    <div id="textToSpeak">
        ...
        <section class="sliders animate__animated animate__fadeIn">
            ...
            {{-- <div class="welcome Header">
                ...
                <h1>Advertising Management System</h1>
            </div> --}}
                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class='carousel-inner banners'>
                        <div class='carousel-item active'>
                            <img src="{{ asset('frontend/img/TEMPORARY ADVERTISE PERMISSION Bg - 1.jpg') }}" alt="">
                        </div>
        ...
        <section class="megaMenus">
            <ul class="d-md-flex">
                <li class="flex-fill normalMenu"><a href="{{ route('application-form') }}"><i class="bi bi-vector-pen"></i> Advertising Management System </a>
                ...
                <li class="flex-fill fullMenu"><a href="https://grievance.panvelcorporation.in/" target = "_blank"><i class="bi bi-briefcase"></i> Grievance </a>
                    {{-- <div class="megaMenusList megaMenusListFirst"><a class="close fs-3"><i class="bi bi-x-square-fill"></i></a>
                        <ul class="row listLink menuIconList">
