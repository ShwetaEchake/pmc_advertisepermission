        ...
        <div class="grid columns-2 gap-4">
            <div class="g-col-2 g-col-xl-1 d-none d-xl-flex flex-column min-vh-screen" style="margin-left: -12%">
                <div class="my-auto text-center">
                    <img alt="Rubick Bootstrap HTML Admin Template" style="margin: auto" class="-intro-x w-1/2 mt-n16" src="{{ asset('frontend/img/pmc.png') }}" />
                    <h3 class="-intro-x text-white fw-medium fs-2xl lh-base mt-3 align-items-start">पनवेल महानगरपालिका</h3> <br>
            ...
            <div class="g-col-2 g-col-xl-1 h-screen h-xl-auto d-flex py-5 py-xl-0 my-10 my-xl-0">
                <div class="my-auto mx-auto ms-xl-20 bg-white dark-bg-dark-1 bg-xl-transparent px-5 px-sm-8 py-8 p-xl-0 rounded-2 shadow-md shadow-xl-none w-full w-sm-3/4 w-lg-2/4 w-xl-auto">
                    ...
                    <form class="theme-form login-form" id="loginForm">
                        @csrf
                        <img alt="Rubick Bootstrap HTML Admin Template" class="-intro-x w-1/2 mt-n16" src="{{ asset('frontend/img/pmc.png') }}" style="margin-left: 35%; width:30%!important; margin-bottom:15px" />
                        <div class="alert alert-primary d-flex align-items-center justify-content-center mb-2" role="alert"> <div><b style="font-size:18px;">ADVERTISING MANAGEMENT SYSTEM</b></div> </div>
